...
BASE_URL = "https://xsxy.nju.edu.cn"
TZGG_URL = f"{BASE_URL}/sylm/tzgg/index.html"
MAX_RECORDS = 400
REQUEST_TIMEOUT = 15
...
TABLE_NAME = "xsxy_nju_edu_cn_news"
SCHEDULE_TIME = "08:00"
...
def run_once():
    ...
    print(f"\n{'='*60}")
    print(f"🚀 新生学院爬虫启动 {start_time.strftime('%Y-%m-%d %H:%M:%S')}")
    print(f"{'='*60}")
